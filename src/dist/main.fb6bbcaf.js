...
var TodoList = /*#__PURE__*/function () {
  ...
  _createClass(TodoList, [{
    ...
    value: function addTodo() {
      ...
      if (todoText) {
        var todo = new TodoItem(todoText);
    ...
    key: "renderTodoItem",
    value: function renderTodoItem(todo) {
      var _this = this;
      var li = document.createElement('li');
      li.classList.add('todo-item');
      li.innerHTML = "\n            <div class=\"todo-info\">\n                <label class=\"checkbox-label\">\n                    <input type=\"checkbox\" class=\"checkbox\">\n                    <span>".concat(todo.text, "</span>\n                </label>\n                <button class=\"done-btn\">Done</button>\n            </div>\n            \n            <div class=\"tag-container\">Priority Level: </div>\n        ");
      var doneBtn = li.querySelector('.done-btn');
      doneBtn.addEventListener('click', function () {
        _this.doneTodoItem(todo);
        _gsap.gsap.to(doneBtn, {
          x: -100,
          opacity: 0,
          duration: 0.5,
          ease: "power2.out",
      ...
      var tagContainer = li.querySelector('.tag-container');
    ...
    key: "doneTodoItem",
    value: function doneTodoItem(todo) {
    ...
    key: "renderTagButtons",
    value: function renderTagButtons(tagContainer) {
      var _this2 = this;
      var priorityTags = ['Low', 'Medium', 'High'];
      priorityTags.forEach(function (tag) {
        var button = document.createElement('button');
        button.textContent = tag;
        button.classList.add('tag-button');
        button.addEventListener('click', function () {
          _this2.setPriority(tag);
          _this2.tagButtons(tagContainer, tag);
          _gsap.gsap.to(button, {
            backgroundColor: _this2.getTagColor(tag),
            color: "#fff",
            duration: 0.3
          });
        });
    ...
    key: "tagButtons",
    value: function tagButtons(tagContainer, selectedTag) {
      var _this3 = this;
      var buttons = tagContainer.querySelectorAll('.tag-button');
      buttons.forEach(function (button) {
        if (button.textContent === selectedTag) {
          button.style.backgroundColor = _this3.getTagColor(selectedTag);
    ...
    key: "getTagColor",
    value: function getTagColor(priority) {
      switch (priority) {
        case 'Low':
          return 'green';
        case 'Medium':
...
var TodoItem = /*#__PURE__*/_createClass(function TodoItem(text) {
